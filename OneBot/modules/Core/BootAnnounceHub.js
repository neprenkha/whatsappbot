...
module.exports.init = async function init(meta) {
  ...
  if (!implFile) {
    meta.log('BootAnnounceHub', `module.error id=${meta.id}, Missing implFile`);
  ...
  try {
    ...
    meta.log('BootAnnounceHub', `module.error id=${meta.id}, Load failed: ${err.message}, file=${absImpl}`);
    return { onEvent: async () => {}, onMessage: async () => {} };
  }
  ...
  if (!impl || typeof impl.init !== 'function') {
    meta.log('BootAnnounceHub', `module.error id=${meta.id}, impl.init() Not Found: ${absImpl}`);
    return { onEvent: async () => {}, onMessage: async () => {} };
  }
